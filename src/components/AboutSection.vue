<template>
  <section id="tentang-kami" class="relative mt-16 pt-20 md:pt-32 pb-16 md:pb-24 px-6 md:px-8 max-w-7xl mx-auto overflow-hidden">
    ...
    <div class="relative grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center z-10">
      
      <div class="relative h-[280px] sm:h-[350px] md:h-[450px] w-full max-w-md mx-auto md:max-w-none group fade-in-left">
        <img 
          src="https://dummyimage.com/400x300/d4d4d4/000000&text=Sawah" 
          alt="Sawah" 
        ...
        />
        <img 
          src="https://dummyimage.com/400x400/a3a3a3/ffffff&text=Mata+Air" 
          alt="Mata Air" 
      ...
      <div class="fade-in-right">
        <div class="inline-block px-4 py-1.5 mb-4 rounded-full bg-teal-50 border border-teal-100 text-[#007b8b] text-xs font-bold tracking-widest shadow-sm">
          TENTANG DESA
        </div>
        ...
        <p class="text-gray-600 mb-4 leading-relaxed text-base md:text-lg">
          Desa Buniara, terletak di Kecamatan Tanjungsiang, Kabupaten Subang, adalah surga tersembunyi yang menawarkan keindahan alam yang asri. Dikelilingi oleh hutan lindung yang rindang, desa ini menjadi tempat yang sempurna untuk melarikan diri dari hiruk-pikuk kota.
        </p>
        <p class="text-gray-600 mb-6 md:mb-8 leading-relaxed text-base md:text-lg">
          Pemandangan desa ini didominasi oleh kemegahan Gunung Canggah yang menjulang setinggi 2.073 mdpl, memberikan udara segar dan pemandangan yang memukau setiap harinya.
        </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 text-gray-700 text-sm font-medium">
          ...
          <div class="flex items-center gap-3 p-3 rounded-xl bg-gray-50 hover:bg-teal-50 border border-transparent hover:border-teal-200 transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-1 cursor-default">
