  ...
  <div class="max-w-4xl mx-auto pb-12 relative">
    ...
    <div v-else>
      ...
      <div class="flex justify-end space-x-4 pt-4 mt-8 mb-4">
        <a href="/" class="px-6 py-2.5 border border-emerald-800 text-emerald-800 font-semibold rounded-full hover:bg-emerald-50 transition-colors flex items-center bg-white">
